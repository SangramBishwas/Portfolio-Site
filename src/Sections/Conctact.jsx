...
const Conctact = () => {
  return (
    <div className="flex flex-col pb-9">
      <h2 className="text-center text-white text-xl my-5 md:text-3xl font-bold" data-aos="fade-up">
        Contact Me
      </h2>
      <p className="text-center text-white" data-aos="fade-up">
        There are several ways to contact with me. If you`d like to contact,
        please click and contact with me
      </p>
      <div className="md:mx-auto my-9 grid grid-cols-2 lg:grid-cols-4 gap-6" data-aos="fade-up">
